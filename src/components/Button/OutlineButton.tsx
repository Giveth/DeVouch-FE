...
export const OutlineButton: FC<OutlineButtonProps> = ({
	...
	return (
		...
		>
			...
			/>
			<button
				className={`font-bold w-full bg-white border-${buttonTypeToColorName[buttonType]} text-${buttonTypeToColorName[buttonType]} border z-1 relative py-4 px-6 group-hover/OutlineButton:animate-color-bounce-enter z-20`}
				{...props}
			>
				{children}
			</button>
