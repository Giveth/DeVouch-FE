	...
	return (
		<>
			<input
				...
				className={`max-h-fit relative inline-block py-2 px-2 border border-gray-300 hover:border-black ${value ? 'flex-1 !border-black pr-16' : ''} outline-none focus:border-black focus:flex-1 focus:pr-16 transition-all`}
				value={value}
